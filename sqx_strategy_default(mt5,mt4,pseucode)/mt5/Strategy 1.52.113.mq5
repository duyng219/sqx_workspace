...
input string CustomComment = "Strategy_1_52_113";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12414;        //MagicNumber
...
string sqStrategyName = "Strategy 1.52.113";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqDaily(NULL,0, "High", 1), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqDaily(NULL,0, "Low", 1), "Current");
