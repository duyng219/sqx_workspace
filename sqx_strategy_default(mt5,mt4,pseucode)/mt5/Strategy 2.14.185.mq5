...
input string CustomComment = "Strategy_2_14_185";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12346;        //MagicNumber
...
input int IchimokuKmoBrkBshTnkPrd1 = 9;        //IchimokuKmoBrkBshTnkPrd1
input int IchimokuKmoBrkBshKjnPrd1 = 83;        //IchimokuKmoBrkBshKjnPrd1
input int IchimokuKmoBrkBshSnkPrd1 = 82;        //IchimokuKmoBrkBshSnkPrd1
input int ExitAfterBars1 = 40;        //ExitAfterBars1
input double ProfitTarget1 = 6.4;        //ProfitTarget1
...
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BollingerBandsPrd1, 0, 1.9, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 2.14.185";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqIchimokuKumoBreakout(-1, NULL,0, ICHIMOKU_1, 1);

     ShortEntrySignal = sqIchimokuKumoBreakout(1, NULL,0, ICHIMOKU_1, 1);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(BOLLINGERBANDS_1, 1 + 1, 3), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 122);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(BOLLINGERBANDS_1, 0 + 1, 3), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BollingerBandsPrd1, 0, 1.9, PRICE_CLOSE);
