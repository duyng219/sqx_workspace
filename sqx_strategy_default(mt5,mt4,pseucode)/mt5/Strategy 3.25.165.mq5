...
input string CustomComment = "Strategy_3_25_165";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12381;        //MagicNumber
...
input double ProfitTarget1 = 4.2;        //ProfitTarget1
input double StopLoss1 = 80;        //StopLoss1
input double TrailingStopCoef1 = 4.7;        //TrailingStopCoef1
input int IchimokuTenkanPrd1 = 90;        //IchimokuTenkanPrd1
input int IchimokuKijunPeriod1 = 125;        //IchimokuKijunPeriod1
input int IchimokuSenkouPrd1 = 112;        //IchimokuSenkouPrd1
input int BiggestRangePeriod1 = 5;        //BiggestRangePeriod1
...
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 165)
...
string sqStrategyName = "Strategy 3.25.165";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (sqOpen("NULL",0, 1+1) < sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 1+1, true) && sqOpen("NULL",0, 1) > sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 1+1, true));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(ICHIMOKU_1, 2, 2) - (PriceEntryMult1 * sqBiggestRange("NULL",0, BiggestRangePeriod1, 1))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 186);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 165);
