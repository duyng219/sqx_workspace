...
input string CustomComment = "Strategy_1_65_113";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12363;        //MagicNumber
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.3, PRICE_TYPICAL)
...
string sqStrategyName = "Strategy 1.65.113";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Open", 2) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.3, PRICE_TYPICAL);
