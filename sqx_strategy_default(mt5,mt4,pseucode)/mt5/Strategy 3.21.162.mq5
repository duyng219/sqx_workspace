...
input string CustomComment = "Strategy_3_21_162";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12393;        //MagicNumber
...
input double PriceEntryMult1 = 0.8;        //PriceEntryMult1
input double ProfitTarget1 = 9.6;        //ProfitTarget1
input double StopLoss1 = 35;        //StopLoss1
input int KeltnerChannelPrd1 = 20;        //KeltnerChannelPrd1
input int MTATRPeriod1 = 30;        //MTATRPeriod1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarOpensPeriod1, 0, 2.7, PRICE_CLOSE)
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarOpensPeriod2, 0, 2.3, PRICE_CLOSE)
#define KELTNERCHANNEL_1 2     //iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 1.5)
#define MTATR_1 3     //iATR(NULL,0, MTATRPeriod1)
...
string sqStrategyName = "Strategy 3.21.162";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqOpen("NULL",0, 3) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 3+1))
      &&   (sqOpen("NULL",0, 3) < sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 3+1)));

     ShortEntrySignal = ((sqOpen("NULL",0, 3) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 3+1))
      &&   (sqOpen("NULL",0, 3) > sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 3+1)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 1) + (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 2))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 42);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 1) - (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 2))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarOpensPeriod2, 0, 2.3, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 1.5);
