...
input string CustomComment = "Strategy_1_39_100";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12412;        //MagicNumber
...
input int BBBarClosesPeriod1 = 10;        //BBBarClosesPeriod1
input double PriceEntryMult1 = 0.6;        //PriceEntryMult1
input double ProfitTarget1 = 10;        //ProfitTarget1
input double StopLoss1 = 30;        //StopLoss1
input double TrailingStopCoef1 = 4.9;        //TrailingStopCoef1
input int LinearRegressionPrd1 = 40;        //LinearRegressionPrd1
...
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.5, PRICE_TYPICAL)
#define BOLLINGERBANDS_3 2     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2, PRICE_CLOSE)
#define LINEARREGRESSION_1 3     //iCustom(NULL,0, "SqLinReg", LinearRegressionPrd1, PRICE_CLOSE)
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 200)
...
string sqStrategyName = "Strategy 1.39.100";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LINEARREGRESSION_1, 0, 3) + (PriceEntryMult1 * sqBarRange("NULL",0, 1))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.5, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_3] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LINEARREGRESSION_1] = iCustom(NULL,0, "SqLinReg", LinearRegressionPrd1, PRICE_CLOSE);
