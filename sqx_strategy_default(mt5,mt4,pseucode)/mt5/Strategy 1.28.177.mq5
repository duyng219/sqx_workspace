...
input string CustomComment = "Strategy_1_28_177";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12360;        //MagicNumber
...
input int BBBarClosesPeriod1 = 20;        //BBBarClosesPeriod1
input int BBBarClosesPeriod2 = 10;        //BBBarClosesPeriod2
input double PriceEntryMult1 = 0.2;        //PriceEntryMult1
input double ProfitTarget1 = 8.6;        //ProfitTarget1
input double StopLoss1 = 45;        //StopLoss1
input int TEMAPeriod1 = 40;        //TEMAPeriod1
input int BBRangePeriod1 = 15;        //BBRangePeriod1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.0, PRICE_CLOSE)
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarClosesPeriod2, 0, 2.6, PRICE_CLOSE)
#define BOLLINGERBANDS_3 2     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2, PRICE_CLOSE)
#define TEMA_1 3     //iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_HIGH)
#define BOLLINGERBANDS_4 4     //iBands(NULL,0, BBRangePeriod1, 0, 2.0, PRICE_CLOSE)
#define TEMA_2 5     //iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_LOW)
#define BOLLINGERBANDS_5 6     //iBands(NULL,0, BBRangePeriod1, 0, 2, PRICE_CLOSE)
#define HEIKENASHI_1 7     //255
...
string sqStrategyName = "Strategy 1.28.177";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqClose("NULL",0, 1) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 1))
      &&   (sqClose("NULL",0, 2) < sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 2)));

     ShortEntrySignal = ((sqClose("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_3, 1, 1))
      &&   (sqClose("NULL",0, 2) > sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 2)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(TEMA_1, 0, 3) - (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_4, 1, 3)-sqGetIndicatorValue(BOLLINGERBANDS_4, 2, 3)))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 138);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(TEMA_2, 0, 3) + (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_5, 1, 3)-sqGetIndicatorValue(BOLLINGERBANDS_5, 2, 3)))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.0, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod2, 0, 2.6, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_3] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TEMA_1] = iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_4] = iBands(NULL,0, BBRangePeriod1, 0, 2.0, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TEMA_2] = iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_5] = iBands(NULL,0, BBRangePeriod1, 0, 2, PRICE_CLOSE);
