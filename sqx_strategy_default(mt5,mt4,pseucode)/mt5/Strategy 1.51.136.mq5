...
input string CustomComment = "Strategy_1_51_136";
...
input int KCBarOpenserPeriod1 = 20;        //KCBarOpenserPeriod1
input double ProfitTarget1 = 6.6;        //ProfitTarget1
input double StopLoss1 = 50;        //StopLoss1
input int IchimokuTenkanPrd1 = 162;        //IchimokuTenkanPrd1
input int IchimokuKijunPeriod1 = 26;        //IchimokuKijunPeriod1
input int IchimokuSenkouPrd1 = 176;        //IchimokuSenkouPrd1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 1.9, PRICE_LOW)
#define KELTNERCHANNEL_1 1     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 2.5)
#define BOLLINGERBANDS_2 2     //iBands(NULL,0, BBBarClosesPeriod1, 0, 1.9, PRICE_HIGH)
...
string sqStrategyName = "Strategy 1.51.136";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqClose("NULL",0, 3) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 3))
      &&   (sqOpen("NULL",0, 3) < sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 3+1)));

     ShortEntrySignal = ((sqClose("NULL",0, 3) > sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 3))
      &&   (sqOpen("NULL",0, 3) > sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 3+1)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(ICHIMOKU_1, 2, 3), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 97);
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 1.9, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 2.5);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod1, 0, 1.9, PRICE_HIGH);
