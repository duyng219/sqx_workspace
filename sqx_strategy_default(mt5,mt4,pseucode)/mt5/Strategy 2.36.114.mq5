...
input string CustomComment = "Strategy_2_36_114";
...
input double ProfitTarget1 = 9.5;        //ProfitTarget1
input double StopLoss1 = 60;        //StopLoss1
input double TrailingStop1 = 100;        //TrailingStop1
input int IchimokuTenkanPrd1 = 107;        //IchimokuTenkanPrd1
input int IchimokuKijunPeriod1 = 159;        //IchimokuKijunPeriod1
input int IchimokuSenkouPrd1 = 33;        //IchimokuSenkouPrd1
input int SmallestRangePeriod1 = 126;        //SmallestRangePeriod1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarOpensPeriod1, 0, 2.5, PRICE_CLOSE)
#define ICHIMOKU_1 1     //iCustom(NULL,0, "SqIchimoku", IchimokuTenkanPrd1, IchimokuKijunPeriod1, IchimokuSenkouPrd1)
...
string sqStrategyName = "Strategy 2.36.114";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(ICHIMOKU_1, 3, 3) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 141);
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarOpensPeriod1, 0, 2.5, PRICE_CLOSE);
