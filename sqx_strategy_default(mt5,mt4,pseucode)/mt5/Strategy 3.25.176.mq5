//+------------------------------------------------------------------+
//| Strategy 3.25.176 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader5 (hedged)
//|    Generated at 08/15/2025 22:09
//| 
//|    Backtested on GBPUSD_M1_dukas / H1, 2003.05.05 - 2024.10.30 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_3_25_176";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12375;        //MagicNumber
...
input int BBBarOpensPeriod2 = 10;        //BBBarOpensPeriod2
input double PriceEntryMult1 = 0.2;        //PriceEntryMult1
input double ProfitTarget1 = 4.3;        //ProfitTarget1
input double StopLoss1 = 8;        //StopLoss1
input int SMAPeriod1 = 50;        //SMAPeriod1
input int BBRangePeriod1 = 10;        //BBRangePeriod1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarOpensPeriod1, 0, 2.8, PRICE_TYPICAL)
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarOpensPeriod2, 0, 1.8, PRICE_HIGH)
#define BOLLINGERBANDS_3 2     //iBands(NULL,0, BBBarOpensPeriod2, 0, 1.8, PRICE_LOW)
#define SMA_1 3     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_WEIGHTED)
#define BOLLINGERBANDS_4 4     //iBands(NULL,0, BBRangePeriod1, 0, 2.0, PRICE_TYPICAL)
#define BOLLINGERBANDS_5 5     //iBands(NULL,0, BBRangePeriod1, 0, 2, PRICE_TYPICAL)
...
string sqStrategyName = "Strategy 3.25.176";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqOpen("NULL",0, 1+1) > sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 1+1, true) && sqOpen("NULL",0, 0) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 1+1, true))
      &&   (sqOpen("NULL",0, 1+1) > sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 1+1, true) && sqOpen("NULL",0, 0) < sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 1+1, true)));

     ShortEntrySignal = ((sqOpen("NULL",0, 1+1) < sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1+1, true) && sqOpen("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1+1, true))
      &&   (sqOpen("NULL",0, 1+1) < sqGetIndicatorValue(BOLLINGERBANDS_3, 1, 1+1, true) && sqOpen("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_3, 1, 1+1, true)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(SMA_1, 0, 2) + (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_4, 1, 3)-sqGetIndicatorValue(BOLLINGERBANDS_4, 2, 3)))), "Current");
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, StopLoss1), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, ProfitTarget1), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 83);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(SMA_1, 0, 2) - (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_5, 1, 3)-sqGetIndicatorValue(BOLLINGERBANDS_5, 2, 3)))), "Current");
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, StopLoss1), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, ProfitTarget1), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarOpensPeriod1, 0, 2.8, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarOpensPeriod2, 0, 1.8, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_3] = iBands(NULL,0, BBBarOpensPeriod2, 0, 1.8, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMA_1] = iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_4] = iBands(NULL,0, BBRangePeriod1, 0, 2.0, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_5] = iBands(NULL,0, BBRangePeriod1, 0, 2, PRICE_TYPICAL);
