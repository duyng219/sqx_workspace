...
input string CustomComment = "Strategy_1_28_149";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12354;        //MagicNumber
...
input int SMMAPeriod1 = 170;        //SMMAPeriod1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 2.1)
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BBBarOpensPeriod1, 0, 2.25, PRICE_TYPICAL)
...
string sqStrategyName = "Strategy 1.28.149";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqOpen("NULL",0, 2) < sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 2+1))
      &&   (sqOpen("NULL",0, 3) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 3+1)));

     ShortEntrySignal = ((sqOpen("NULL",0, 2) > sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 2+1))
      &&   (sqOpen("NULL",0, 3) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 3+1)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(SMMA_1, 0, 2), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 131);
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 2.1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarOpensPeriod1, 0, 2.25, PRICE_TYPICAL);
