...
input string CustomComment = "Strategy_3_5_139";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12390;        //MagicNumber
...
input int MAPeriod1 = 40;        //MAPeriod1
input int BBBarOpensPeriod1 = 33;        //BBBarOpensPeriod1
input int BBBarOpensPeriod2 = 50;        //BBBarOpensPeriod2
input double ProfitTarget1 = 9;        //ProfitTarget1
input double StopLoss1 = 70;        //StopLoss1
input int SMAPeriod1 = 40;        //SMAPeriod1
...
#define MOVINGAVERAGE_1 0     //iMA(NULL,0, MAPeriod1, 0, MODE_SMA, PRICE_CLOSE)
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BBBarOpensPeriod1, 0, 2.7, PRICE_CLOSE)
#define BOLLINGERBANDS_2 2     //iBands(NULL,0, BBBarOpensPeriod2, 0, 2.1, PRICE_CLOSE)
#define SMA_1 3     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 3.5.139";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsFalling(MOVINGAVERAGE_1, 2, false, 2)
      &&   (sqOpen("NULL",0, 1+1) > sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 1+1, true) && sqOpen("NULL",0, 0) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 1+1, true)))
     ...
     ShortEntrySignal = (((sqGetIndicatorValue(MOVINGAVERAGE_1, 2+1)<sqGetIndicatorValue(MOVINGAVERAGE_1, 2))
      &&   (sqOpen("NULL",0, 1+1) < sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1+1, true) && sqOpen("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1+1, true)))
      &&   (sqOpen("NULL",0, 1+1) < sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 1+1, true) && sqOpen("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 1+1, true)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(SMA_1, 0, 1), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 136);
...
bool initIndicators(){
   ...
   indicatorHandles[MOVINGAVERAGE_1] = iMA(NULL,0, MAPeriod1, 0, MODE_SMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarOpensPeriod1, 0, 2.7, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarOpensPeriod2, 0, 2.1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMA_1] = iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_CLOSE);
