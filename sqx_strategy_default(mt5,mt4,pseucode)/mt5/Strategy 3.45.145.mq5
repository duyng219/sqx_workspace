...
input string CustomComment = "Strategy_3_45_145";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12364;        //MagicNumber
...
input double ProfitTarget1 = 7.9;        //ProfitTarget1
input double StopLoss1 = 5.9;        //StopLoss1
input double TrailingStopCoef1 = 3.9;        //TrailingStopCoef1
input double TrailingActCef1 = 5;        //TrailingActCef1
input int IchimokuTenkanPrd1 = 9;        //IchimokuTenkanPrd1
input int IchimokuKijunPeriod1 = 132;        //IchimokuKijunPeriod1
input int IchimokuSenkouPrd1 = 106;        //IchimokuSenkouPrd1
...
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.1, PRICE_CLOSE)
#define BOLLINGERBANDS_3 2     //iBands(NULL,0, BBBarOpensPeriod1, 0, 2, PRICE_CLOSE)
#define ICHIMOKU_1 3     //iCustom(NULL,0, "SqIchimoku", IchimokuTenkanPrd1, IchimokuKijunPeriod1, IchimokuSenkouPrd1)
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 25)
#define ATR_2 5     //iCustom(NULL, 0, "SqATR", 55)
...
string sqStrategyName = "Strategy 3.45.145";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqOpen("NULL",0, 3) < sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 3+1))
      &&   (sqClose("NULL",0, 1) < sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 1)));

     ShortEntrySignal = ((sqOpen("NULL",0, 3) > sqGetIndicatorValue(BOLLINGERBANDS_3, 2, 3+1))
      &&   (sqClose("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 1)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(ICHIMOKU_1, 2, 2) - (PriceEntryMult1 * sqBarRange("NULL",0, 1))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 21);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_3] = iBands(NULL,0, BBBarOpensPeriod1, 0, 2, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ICHIMOKU_1] = iCustom(NULL,0, "SqIchimoku", IchimokuTenkanPrd1, IchimokuKijunPeriod1, IchimokuSenkouPrd1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 25);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 55);
