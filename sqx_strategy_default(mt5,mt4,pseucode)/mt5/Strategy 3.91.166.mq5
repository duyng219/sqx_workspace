...
input string CustomComment = "Strategy_3_91_166";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12387;        //MagicNumber
...
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", Period1, PRICE_CLOSE)
#define LOWEST_1 2     //iCustom(NULL,0, "SqLowest", Period1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 3.91.166";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(HIGHEST_1, 0, 2), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 127);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(LOWEST_1, 0, 2), "Current");
