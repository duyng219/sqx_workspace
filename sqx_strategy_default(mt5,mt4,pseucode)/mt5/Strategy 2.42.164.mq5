...
input string CustomComment = "Strategy_2_42_164";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12398;        //MagicNumber
...
input int IchimokuKmoBrkBshTnkPrd1 = 39;        //IchimokuKmoBrkBshTnkPrd1
input int IchimokuKmoBrkBshKjnPrd1 = 26;        //IchimokuKmoBrkBshKjnPrd1
...
string sqStrategyName = "Strategy 2.42.164";
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 102);
