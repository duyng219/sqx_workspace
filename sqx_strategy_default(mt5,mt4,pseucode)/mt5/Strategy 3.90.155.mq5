...
input string CustomComment = "Strategy_3_90_155";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12404;        //MagicNumber
...
input int BBBarClosesPeriod1 = 48;        //BBBarClosesPeriod1
input double PriceEntryMult1 = 0.4;        //PriceEntryMult1
input double ProfitTarget1 = 6.5;        //ProfitTarget1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.8, PRICE_WEIGHTED)
...
string sqStrategyName = "Strategy 3.90.155";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Close", 2) - (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 2))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.8, PRICE_WEIGHTED);
