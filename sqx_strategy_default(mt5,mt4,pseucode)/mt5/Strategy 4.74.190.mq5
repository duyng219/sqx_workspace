...
input string CustomComment = "Strategy_4_74_190";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12361;        //MagicNumber
...
input int KCBarOpnAftOpnPrd1 = 10;        //KCBarOpnAftOpnPrd1
input double PriceEntryMult1 = 1.5;        //PriceEntryMult1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 2.25)
#define TEMA_1 1     //iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_WEIGHTED)
...
string sqStrategyName = "Strategy 4.74.190";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(TEMA_1, 0, 3) + (PriceEntryMult1 * sqBiggestRange("NULL",0, BiggestRangePeriod1, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 74);
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 2.25);
