...
input string CustomComment = "Strategy_1_40_191";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12392;        //MagicNumber
...
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", Period1, PRICE_WEIGHTED)
#define LOWEST_1 3     //iCustom(NULL,0, "SqLowest", Period1, PRICE_WEIGHTED)
...
string sqStrategyName = "Strategy 1.40.191";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 1) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 171);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 1) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
