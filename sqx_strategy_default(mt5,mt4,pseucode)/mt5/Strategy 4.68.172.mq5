...
input string CustomComment = "Strategy_4_68_172";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12394;        //MagicNumber
...
input int IchimokuKmoBrkBshTnkPrd1 = 26;        //IchimokuKmoBrkBshTnkPrd1
input int IchimokuKmoBrkBshKjnPrd1 = 81;        //IchimokuKmoBrkBshKjnPrd1
input int IchimokuKmoBrkBshSnkPrd1 = 115;        //IchimokuKmoBrkBshSnkPrd1
input double PriceEntryMult1 = 0.5;        //PriceEntryMult1
input double ProfitTarget1 = 9.9;        //ProfitTarget1
...
#define PARABOLICSAR_1 1     //iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.10)
#define PARABOLICSAR_2 2     //iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.1)
...
string sqStrategyName = "Strategy 4.68.172";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqIchimokuKumoBreakout(-1, NULL,0, ICHIMOKU_1, 2);

     ShortEntrySignal = sqIchimokuKumoBreakout(1, NULL,0, ICHIMOKU_1, 2);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(PARABOLICSAR_1, 0, 1) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(PARABOLICSAR_2, 0, 1) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.10);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_2] = iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.1);
