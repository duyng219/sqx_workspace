...
input string CustomComment = "Strategy_4_40_100";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12353;        //MagicNumber
...
input int ExitAfterBars1 = 38;        //ExitAfterBars1
input double ProfitTarget1 = 4.9;        //ProfitTarget1
input double StopLoss1 = 50;        //StopLoss1
input int Period1 = 40;        //Period1
...
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", Period1, PRICE_WEIGHTED)
#define LOWEST_1 2     //iCustom(NULL,0, "SqLowest", Period1, PRICE_WEIGHTED)
...
string sqStrategyName = "Strategy 4.40.100";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(HIGHEST_1, 0, 1), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 154);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(LOWEST_1, 0, 1), "Current");
