...
input string CustomComment = "Strategy_2_51_116";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12356;        //MagicNumber
...
input int IchimokuKmoBrkBshTnkPrd1 = 166;        //IchimokuKmoBrkBshTnkPrd1
input int IchimokuKmoBrkBshKjnPrd1 = 123;        //IchimokuKmoBrkBshKjnPrd1
input int IchimokuKmoBrkBshSnkPrd1 = 52;        //IchimokuKmoBrkBshSnkPrd1
input double PriceEntryMult1 = 0.7;        //PriceEntryMult1
input double ProfitTarget1 = 7.7;        //ProfitTarget1
input double StopLoss1 = 4.5;        //StopLoss1
input double TrailingStop1 = 50;        //TrailingStop1
input int MTKeltnerChannelPrd1 = 20;        //MTKeltnerChannelPrd1
...
#define ICHIMOKU_1 0     //iCustom(NULL,0, "SqIchimoku", IchimokuKmoBrkBshTnkPrd1, IchimokuKmoBrkBshKjnPrd1, IchimokuKmoBrkBshSnkPrd1)
#define MTKELTNERCHANNEL_1 1     //iCustom(NULL,0, "SqMTKeltnerChannel", MTKeltnerChannelPrd1, 1.5)
...
string sqStrategyName = "Strategy 2.51.116";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqIchimokuKumoBreakout(-1, NULL,0, ICHIMOKU_1, 3);

     ShortEntrySignal = sqIchimokuKumoBreakout(1, NULL,0, ICHIMOKU_1, 3);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(MTKELTNERCHANNEL_1, 0, 1) + (PriceEntryMult1 * sqBarRange("NULL",0, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 62);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(MTKELTNERCHANNEL_1, 1, 1) - (PriceEntryMult1 * sqBarRange("NULL",0, 3))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[ICHIMOKU_1] = iCustom(NULL,0, "SqIchimoku", IchimokuKmoBrkBshTnkPrd1, IchimokuKmoBrkBshKjnPrd1, IchimokuKmoBrkBshSnkPrd1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTKELTNERCHANNEL_1] = iCustom(NULL,0, "SqMTKeltnerChannel", MTKeltnerChannelPrd1, 1.5);
