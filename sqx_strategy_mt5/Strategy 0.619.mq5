...
input string CustomComment = "Strategy_0_619";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12352;        //MagicNumber
...
input int HMAPeriod1 = 24;        //HMAPeriod1
input double PriceEntryMult1 = 2.8;        //PriceEntryMult1
input double StopLossCoef1 = 1.5;        //StopLossCoef1
input double TrailingStopCoef1 = 1.8;        //TrailingStopCoef1
input double TrailingActCef1 = 3.7;        //TrailingActCef1
input int ATRPeriod1 = 14;        //ATRPeriod1
...
#define HULLMOVINGAVERAGE_1 0     //iCustom(NULL,0, "SqHullMovingAverage", HMAPeriod1, 2.0, PRICE_CLOSE)
#define ATR_1 1     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define ATR_2 2     //iCustom(NULL, 0, "SqATR", 30)
#define ATR_3 3     //iCustom(NULL, 0, "SqATR", 75)
#define ATR_4 4     //iCustom(NULL, 0, "SqATR", 60)
...
string sqStrategyName = "Strategy 0.619";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqIsRising(HULLMOVINGAVERAGE_1, 2, false, 1);

     ShortEntrySignal = sqIsFalling(HULLMOVINGAVERAGE_1, 2, false, 1);
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 18);

         //Check StopLoss & ProfitTarget
         //sqCheckSLPT(_ticket, sl, pt);

         // TrailingStop initialization
         sqSetTrailingStop(_ticket, "TrailingStopCoef1 * sqGetIndicatorValue(ATR_3, 1)", SLPTTYPE_RANGE);
...
bool initIndicators(){
   ...
   indicatorHandles[HULLMOVINGAVERAGE_1] = iCustom(NULL,0, "SqHullMovingAverage", HMAPeriod1, 2.0, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL,0, "SqATR", ATRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 30);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 75);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(NULL, 0, "SqATR", 60);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("TrailingStopCoef1 * sqGetIndicatorValue(ATR_3, 1)")) {
      return (TrailingStopCoef1 * sqGetIndicatorValue(ATR_3, 1));
   }
