...
input string CustomComment = "Strategy_3_24_146";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12383;        //MagicNumber
...
input int BBBarClosesPeriod1 = 60;        //BBBarClosesPeriod1
input int BBBarOpensPeriod1 = 20;        //BBBarOpensPeriod1
input double ProfitTarget1 = 8.3;        //ProfitTarget1
input double StopLoss1 = 35;        //StopLoss1
input int LinearRegressionPrd1 = 144;        //LinearRegressionPrd1
...
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarOpensPeriod1, 0, 2.1, PRICE_CLOSE)
#define LINEARREGRESSION_1 2     //iCustom(NULL,0, "SqLinReg", LinearRegressionPrd1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 3.24.146";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(LINEARREGRESSION_1, 0, 2), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarOpensPeriod1, 0, 2.1, PRICE_CLOSE);
