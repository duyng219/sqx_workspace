...
input string CustomComment = "Strategy_1_31_142";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12409;        //MagicNumber
...
input int ATRRisingPeriod1 = 30;        //ATRRisingPeriod1
input double PriceEntryMult1 = 0.7;        //PriceEntryMult1
input double ProfitTarget1 = 2.6;        //ProfitTarget1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarOpensPeriod1, 0, 2.25, PRICE_CLOSE)
#define ATR_1 1     //iCustom(NULL,0, "SqATR", ATRRisingPeriod1)
...
string sqStrategyName = "Strategy 1.31.142";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "High", 3) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Low", 3) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarOpensPeriod1, 0, 2.25, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL,0, "SqATR", ATRRisingPeriod1);
