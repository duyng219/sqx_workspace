...
input string CustomComment = "Strategy_1_51_117";
...
input int LWMAPeriod1 = 40;        //LWMAPeriod1
...
#define LWMA_1 2     //iMA(NULL,0, LWMAPeriod1, 0, MODE_LWMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 1.51.117";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LWMA_1, 0, 2) + (PriceEntryMult1 * sqBarRange("NULL",0, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 145);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LWMA_1] = iMA(NULL,0, LWMAPeriod1, 0, MODE_LWMA, PRICE_CLOSE);
