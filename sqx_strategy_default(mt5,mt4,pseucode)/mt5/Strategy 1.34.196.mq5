...
input string CustomComment = "Strategy_1_34_196";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12402;        //MagicNumber
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.2, PRICE_WEIGHTED)
#define ATR_1 1     //iCustom(NULL,0, "SqATR", ATRChangesUpPeriod1)
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", Period1, PRICE_OPEN)
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 195)
#define LOWEST_1 4     //iCustom(NULL,0, "SqLowest", Period1, PRICE_OPEN)
...
string sqStrategyName = "Strategy 1.34.196";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(HIGHEST_1, 0, 3), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 146);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(LOWEST_1, 0, 3), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.2, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL,0, "SqATR", ATRChangesUpPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", Period1, PRICE_OPEN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 195);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", Period1, PRICE_OPEN);
