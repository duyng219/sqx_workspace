...
input string CustomComment = "Strategy_3_63_186";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12406;        //MagicNumber
...
input double ProfitTarget1 = 6;        //ProfitTarget1
input double StopLoss1 = 45;        //StopLoss1
input double TrailingStop1 = 100;        //TrailingStop1
input int SmallestRangePeriod1 = 93;        //SmallestRangePeriod1
...
string sqStrategyName = "Strategy 3.63.186";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "High", 3) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 2))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 162);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Low", 3) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 2))), "Current");
