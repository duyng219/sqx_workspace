...
input string CustomComment = "Strategy_1_43_166";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12380;        //MagicNumber
...
input double TrailingStopCoef1 = 4;        //TrailingStopCoef1
...
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarClosesPeriod2, 0, 2.2, PRICE_OPEN)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 20)
...
string sqStrategyName = "Strategy 1.43.166";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqDaily(NULL,0, "Open", 2), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod2, 0, 2.2, PRICE_OPEN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 20);
