...
input string CustomComment = "Strategy_1_28_137";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12371;        //MagicNumber
...
input int BBBarClosesPeriod1 = 50;        //BBBarClosesPeriod1
input int ATRChangesUpPeriod1 = 90;        //ATRChangesUpPeriod1
input double PriceEntryMult1 = 0.1;        //PriceEntryMult1
input double ProfitTarget1 = 7.3;        //ProfitTarget1
input double StopLoss1 = 40;        //StopLoss1
input double TrailingStop1 = 70;        //TrailingStop1
input int Period1 = 10;        //Period1
input int BBRangePeriod1 = 50;        //BBRangePeriod1
...
#define ATR_1 1     //iCustom(NULL,0, "SqATR", ATRChangesUpPeriod1)
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", Period1, PRICE_CLOSE)
#define BOLLINGERBANDS_2 3     //iBands(NULL,0, BBRangePeriod1, 0, 2.1, PRICE_CLOSE)
#define LOWEST_1 4     //iCustom(NULL,0, "SqLowest", Period1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 1.28.137";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqClose("NULL",0, 2) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 2))
      &&   changesUp(ATR_1, 2));

     ShortEntrySignal = ((sqClose("NULL",0, 2) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 2))
      &&   changesUp(ATR_1, 2));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 2) + (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 1)-sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 1)))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 135);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 2) - (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 1)-sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 1)))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", Period1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBRangePeriod1, 0, 2.1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", Period1, PRICE_CLOSE);
