...
input string CustomComment = "Strategy_2_24_179";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12366;        //MagicNumber
...
input int IchimokuSnkSpnCrsBshTnkPrd1 = 9;        //IchimokuSnkSpnCrsBshTnkPrd1
input int IchimokuSnkSpnCrsBshKjnPrd1 = 26;        //IchimokuSnkSpnCrsBshKjnPrd1
input int IchimokuSnkSpnCrsBshSnkPrd1 = 35;        //IchimokuSnkSpnCrsBshSnkPrd1
input double PriceEntryMult1 = 1.1;        //PriceEntryMult1
input int ExitAfterBars1 = 36;        //ExitAfterBars1
input double ProfitTarget1 = 4.6;        //ProfitTarget1
input double StopLoss1 = 9.7;        //StopLoss1
input int IchimokuTenkanPrd1 = 9;        //IchimokuTenkanPrd1
input int IchimokuKijunPeriod1 = 26;        //IchimokuKijunPeriod1
input int IchimokuSenkouPrd1 = 52;        //IchimokuSenkouPrd1
...
#define ICHIMOKU_1 0     //iCustom(NULL,0, "SqIchimoku", IchimokuSnkSpnCrsBshTnkPrd1, IchimokuSnkSpnCrsBshKjnPrd1, IchimokuSnkSpnCrsBshSnkPrd1)
#define ICHIMOKU_2 1     //iCustom(NULL,0, "SqIchimoku", IchimokuTenkanPrd1, IchimokuKijunPeriod1, IchimokuSenkouPrd1)
#define BOLLINGERBANDS_1 2     //iBands(NULL,0, BBRangePeriod1, 0, 1.9, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 2.24.179";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqIchimokuSenkouSpanCross(-1, NULL,0, ICHIMOKU_1, 2, 2);

     ShortEntrySignal = sqIchimokuSenkouSpanCross(1, NULL,0, ICHIMOKU_1, 2, 2);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(ICHIMOKU_2, 3, 2) + (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 3)-sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 3)))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[ICHIMOKU_1] = iCustom(NULL,0, "SqIchimoku", IchimokuSnkSpnCrsBshTnkPrd1, IchimokuSnkSpnCrsBshKjnPrd1, IchimokuSnkSpnCrsBshSnkPrd1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ICHIMOKU_2] = iCustom(NULL,0, "SqIchimoku", IchimokuTenkanPrd1, IchimokuKijunPeriod1, IchimokuSenkouPrd1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBRangePeriod1, 0, 1.9, PRICE_CLOSE);
