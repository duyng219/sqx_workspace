...
input string CustomComment = "Strategy_4_72_146";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12359;        //MagicNumber
...
input double ProfitTarget1 = 170;        //ProfitTarget1
input double StopLoss1 = 9.1;        //StopLoss1
...
string sqStrategyName = "Strategy 4.72.146";
