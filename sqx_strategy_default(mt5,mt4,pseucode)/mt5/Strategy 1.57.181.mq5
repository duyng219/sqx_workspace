...
input string CustomComment = "Strategy_1_57_181";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12365;        //MagicNumber
...
input int ATRChangesUpPeriod1 = 166;        //ATRChangesUpPeriod1
input double PriceEntryMult1 = 2.6;        //PriceEntryMult1
input double ProfitTarget1 = 1.7;        //ProfitTarget1
input double StopLoss1 = 30;        //StopLoss1
input int MTATRPeriod1 = 20;        //MTATRPeriod1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 3.0, PRICE_TYPICAL)
#define ATR_1 1     //iCustom(NULL,0, "SqATR", ATRChangesUpPeriod1)
#define BOLLINGERBANDS_2 2     //iBands(NULL,0, BBBarClosesPeriod1, 0, 3, PRICE_TYPICAL)
#define PARABOLICSAR_1 3     //iCustom(NULL,0, "SqParabolicSAR", 0.010, 0.20)
#define MTATR_1 4     //iATR(NULL,0, MTATRPeriod1)
#define PARABOLICSAR_2 5     //iCustom(NULL,0, "SqParabolicSAR", 0.01, 0.2)
...
string sqStrategyName = "Strategy 1.57.181";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((sqClose("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 1))
      &&   changesUp(ATR_1, 2));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(PARABOLICSAR_1, 0, 1) - (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 2))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 168);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(PARABOLICSAR_2, 0, 1) + (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 2))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 3.0, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL,0, "SqATR", ATRChangesUpPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod1, 0, 3, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.010, 0.20);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTATR_1] = iATR(NULL,0, MTATRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_2] = iCustom(NULL,0, "SqParabolicSAR", 0.01, 0.2);
