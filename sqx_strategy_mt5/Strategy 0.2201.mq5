...
input string CustomComment = "Strategy_0_2201";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12348;        //MagicNumber
...
input int ATRPeriod2 = 14;        //ATRPeriod2
input double PriceEntryMult1 = 2.8;        //PriceEntryMult1
input double StopLossCoef1 = 1.6;        //StopLossCoef1
input double TrailingStopCoef1 = 3;        //TrailingStopCoef1
input double TrailingActivation1 = 5;        //TrailingActivation1
input int ATRPeriod3 = 30;        //ATRPeriod3
...
#define ATR_1 0     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define ATR_2 1     //iCustom(NULL,0, "SqATR", ATRPeriod2)
#define ATR_3 2     //iCustom(NULL,0, "SqATR", ATRPeriod3)
#define ATR_4 3     //iCustom(NULL, 0, "SqATR", 50)
#define ATR_5 4     //iCustom(NULL, 0, "SqATR", 45)
#define HEIKENASHI_1 5     //255
...
string sqStrategyName = "Strategy 0.2201";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) == NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6));

     ShortEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) != NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqClose(NULL,0, 1) + (PriceEntryMult1 * sqGetIndicatorValue(ATR_3, 0, 1))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 2, StopLossCoef1 * sqGetIndicatorValue(ATR_4, 1)), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 14);

         //Check StopLoss & ProfitTarget
         //sqCheckSLPT(_ticket, sl, pt);

         // TrailingStop initialization
         sqSetTrailingStop(_ticket, "TrailingStopCoef1 * sqGetIndicatorValue(ATR_5, 1)", SLPTTYPE_RANGE);
         sqSetTSActivation(_ticket, "TrailingActivation1");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqClose(NULL,0, 1) - (PriceEntryMult1 * sqGetIndicatorValue(ATR_3, 0, 1))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, StopLossCoef1 * sqGetIndicatorValue(ATR_4, 1)), "Current");
      pt = sqFixMarketPrice(0, "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL,0, "SqATR", ATRPeriod3);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(NULL, 0, "SqATR", 50);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_5] = iCustom(NULL, 0, "SqATR", 45);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("StopLossCoef1 * sqGetIndicatorValue(ATR_4, 1)")) {
      return (StopLossCoef1 * sqGetIndicatorValue(ATR_4, 1));
   }
   if(idHash == sqStringHash("TrailingStopCoef1 * sqGetIndicatorValue(ATR_5, 1)")) {
      return (TrailingStopCoef1 * sqGetIndicatorValue(ATR_5, 1));
   }
   if(idHash == sqStringHash("TrailingActivation1")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), TrailingActivation1));
   }
   if(idHash == sqStringHash("StopLossCoef1 * sqGetIndicatorValue(ATR_4, 1)")) {
      return (StopLossCoef1 * sqGetIndicatorValue(ATR_4, 1));
   }
