...
input string CustomComment = "Strategy_3_41_167";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12405;        //MagicNumber
...
input int BBBarClosesPeriod2 = 50;        //BBBarClosesPeriod2
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.25, PRICE_CLOSE)
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarClosesPeriod2, 0, 2.1, PRICE_CLOSE)
#define MTKELTNERCHANNEL_1 2     //iCustom(NULL,0, "SqMTKeltnerChannel", MTKeltnerChannelPrd1, 2.0)
#define MTKELTNERCHANNEL_2 3     //iCustom(NULL,0, "SqMTKeltnerChannel", MTKeltnerChannelPrd1, 2)
...
string sqStrategyName = "Strategy 3.41.167";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(MTKELTNERCHANNEL_1, 0, 2), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 140);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(MTKELTNERCHANNEL_2, 1, 2), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.25, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod2, 0, 2.1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTKELTNERCHANNEL_1] = iCustom(NULL,0, "SqMTKeltnerChannel", MTKeltnerChannelPrd1, 2.0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTKELTNERCHANNEL_2] = iCustom(NULL,0, "SqMTKeltnerChannel", MTKeltnerChannelPrd1, 2);
