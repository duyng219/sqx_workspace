...
input string CustomComment = "Strategy_1_52_186";
...
input int SmallestRangePeriod1 = 30;        //SmallestRangePeriod1
...
#define BOLLINGERBANDS_3 2     //iBands(NULL,0, BBBarClosesPeriod1, 0, 1.9, PRICE_HIGH)
...
string sqStrategyName = "Strategy 1.52.186";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "High", 1) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 27);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Low", 1) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_3] = iBands(NULL,0, BBBarClosesPeriod1, 0, 1.9, PRICE_HIGH);
