...
input string CustomComment = "Strategy_3_73_104";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12388;        //MagicNumber
...
input double PriceEntryMult1 = 0.4;        //PriceEntryMult1
input double ProfitTarget1 = 7.6;        //ProfitTarget1
input double StopLoss1 = 55;        //StopLoss1
input double TrailingStopCoef1 = 2.9;        //TrailingStopCoef1
input int Period1 = 20;        //Period1
input int MTATRPeriod1 = 40;        //MTATRPeriod1
...
#define MTATR_1 2     //iATR(NULL,0, MTATRPeriod1)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 80)
#define LOWEST_1 4     //iCustom(NULL,0, "SqLowest", Period1, PRICE_MEDIAN)
...
string sqStrategyName = "Strategy 3.73.104";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 1) - (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 1))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 8);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 1) + (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 1))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 80);
