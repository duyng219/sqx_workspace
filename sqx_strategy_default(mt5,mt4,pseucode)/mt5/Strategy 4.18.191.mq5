...
input string CustomComment = "Strategy_4_18_191";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12347;        //MagicNumber
...
input int ATRChangesUpPeriod1 = 159;        //ATRChangesUpPeriod1
input int KCBarOpnAftOpnPrd1 = 14;        //KCBarOpnAftOpnPrd1
input int ATRChangesUpPeriod2 = 30;        //ATRChangesUpPeriod2
input double PriceEntryMult1 = 1.4;        //PriceEntryMult1
input int ExitAfterBars1 = 28;        //ExitAfterBars1
input double ProfitTarget1 = 2.1;        //ProfitTarget1
input double StopLoss1 = 65;        //StopLoss1
input double TrailingStop1 = 100;        //TrailingStop1
input double TrailingActivation1 = 90;        //TrailingActivation1
input int SMMAPeriod1 = 20;        //SMMAPeriod1
input int MTATRPeriod1 = 50;        //MTATRPeriod1
...
#define ATR_1 0     //iCustom(NULL,0, "SqATR", ATRChangesUpPeriod1)
#define KELTNERCHANNEL_1 1     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 2.0)
#define ATR_2 2     //iCustom(NULL,0, "SqATR", ATRChangesUpPeriod2)
#define KELTNERCHANNEL_2 3     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 2)
#define SMMA_1 4     //iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_CLOSE)
#define MTATR_1 5     //iATR(NULL,0, MTATRPeriod1)
...
string sqStrategyName = "Strategy 4.18.191";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((changesUp(ATR_1, 3)
      &&   (sqOpen("NULL",0, 1+1) > sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 1+1, true) && sqOpen("NULL",0, 1) < sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 1+1, true)))
      &&   changesUp(ATR_2, 3));

     ShortEntrySignal = ((changesUp(ATR_1, 3)
      &&   (sqOpen("NULL",0, 1+1) < sqGetIndicatorValue(KELTNERCHANNEL_2, 0, 1+1, true) && sqOpen("NULL",0, 1) > sqGetIndicatorValue(KELTNERCHANNEL_2, 0, 1+1, true)))
      &&   changesUp(ATR_2, 3));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(SMMA_1, 0, 3) + (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 1))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 167);
...
bool initIndicators(){
   ...
   indicatorHandles[ATR_1] = iCustom(NULL,0, "SqATR", ATRChangesUpPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 2.0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL,0, "SqATR", ATRChangesUpPeriod2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_2] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMMA_1] = iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTATR_1] = iATR(NULL,0, MTATRPeriod1);
