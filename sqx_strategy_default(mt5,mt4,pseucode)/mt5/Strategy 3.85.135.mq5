...
input string CustomComment = "Strategy_3_85_135";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12355;        //MagicNumber
...
input int BBBarClosesPeriod1 = 40;        //BBBarClosesPeriod1
input double PriceEntryMult1 = 1.6;        //PriceEntryMult1
input int ExitAfterBars1 = 42;        //ExitAfterBars1
input double ProfitTarget1 = 6.8;        //ProfitTarget1
input double StopLoss1 = 75;        //StopLoss1
input int BollingerBandsPrd1 = 20;        //BollingerBandsPrd1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.5, PRICE_CLOSE)
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BollingerBandsPrd1, 0, 1.9, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 3.85.135";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_2, 0 + 1, 3) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 63);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_2, 1 + 1, 3) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.5, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BollingerBandsPrd1, 0, 1.9, PRICE_CLOSE);
