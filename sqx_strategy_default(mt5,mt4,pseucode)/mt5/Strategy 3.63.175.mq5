...
input string CustomComment = "Strategy_3_63_175";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12408;        //MagicNumber
...
input double PriceEntryMult1 = 0.9;        //PriceEntryMult1
input double ProfitTarget1 = 110;        //ProfitTarget1
input double StopLoss1 = 40;        //StopLoss1
input double TrailingStop1 = 50;        //TrailingStop1
input double TrailingActCef1 = 3.8;        //TrailingActCef1
input int Period1 = 20;        //Period1
input int SmallestRangePeriod1 = 20;        //SmallestRangePeriod1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.4, PRICE_CLOSE)
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", Period1, PRICE_MEDIAN)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 200)
#define LOWEST_1 3     //iCustom(NULL,0, "SqLowest", Period1, PRICE_MEDIAN)
...
string sqStrategyName = "Strategy 3.63.175";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 3) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 47);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 3) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.4, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", Period1, PRICE_MEDIAN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 200);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", Period1, PRICE_MEDIAN);
