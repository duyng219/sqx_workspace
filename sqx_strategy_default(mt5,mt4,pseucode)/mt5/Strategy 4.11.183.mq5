...
input string CustomComment = "Strategy_4_11_183";
...
input int MACDMainCrossFast1 = 12;        //MACDMainCrossFast1
input int MACDMainCrossSlow1 = 52;        //MACDMainCrossSlow1
input int MACDMainCrossSmooth1 = 9;        //MACDMainCrossSmooth1
input double ProfitTarget1 = 7.1;        //ProfitTarget1
...
#define MACD_1 0     //iMACD(NULL,0, MACDMainCrossFast1, MACDMainCrossSlow1, MACDMainCrossSmooth1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 4.11.183";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = crossesDown(MACD_1, 2, -0.0);

     ShortEntrySignal = crossesUp(MACD_1, 2, 0);
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 128);
...
bool initIndicators(){
   ...
   indicatorHandles[MACD_1] = iMACD(NULL,0, MACDMainCrossFast1, MACDMainCrossSlow1, MACDMainCrossSmooth1, PRICE_CLOSE);
