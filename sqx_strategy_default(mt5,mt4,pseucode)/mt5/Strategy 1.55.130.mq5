...
input string CustomComment = "Strategy_1_55_130";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12400;        //MagicNumber
...
input double PriceEntryMult1 = 0.3;        //PriceEntryMult1
input double ProfitTarget1 = 1.2;        //ProfitTarget1
input double StopLoss1 = 80;        //StopLoss1
input int BollingerBandsPrd1 = 119;        //BollingerBandsPrd1
...
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.0, PRICE_WEIGHTED)
#define BOLLINGERBANDS_2 2     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2, PRICE_WEIGHTED)
#define BOLLINGERBANDS_3 3     //iBands(NULL,0, BollingerBandsPrd1, 0, 2.0, PRICE_TYPICAL)
#define ATR_2 4     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define BOLLINGERBANDS_4 5     //iBands(NULL,0, BollingerBandsPrd1, 0, 2, PRICE_TYPICAL)
...
string sqStrategyName = "Strategy 1.55.130";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (changesUp(ATR_1, 3)
      &&   (sqClose("NULL",0, 2) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 2)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_3, 0 + 1, 1) + (PriceEntryMult1 * sqGetIndicatorValue(ATR_2, 0, 1))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 195);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_4, 1 + 1, 1) - (PriceEntryMult1 * sqGetIndicatorValue(ATR_2, 0, 1))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.0, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_3] = iBands(NULL,0, BollingerBandsPrd1, 0, 2.0, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL,0, "SqATR", ATRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_4] = iBands(NULL,0, BollingerBandsPrd1, 0, 2, PRICE_TYPICAL);
