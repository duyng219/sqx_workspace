...
input string CustomComment = "Strategy_1_29_178";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12368;        //MagicNumber
...
input double StopLoss1 = 7;        //StopLoss1
input double TrailingStop1 = 90;        //TrailingStop1
input double TrailingActCef1 = 2;        //TrailingActCef1
input int BiggestRangePeriod1 = 20;        //BiggestRangePeriod1
...
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.6, PRICE_CLOSE)
#define ATR_2 2     //iCustom(NULL, 0, "SqATR", 140)
...
string sqStrategyName = "Strategy 1.29.178";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (changesUp(ATR_1, 2)
      &&   (sqClose("NULL",0, 2) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 2)));

     ShortEntrySignal = (changesUp(ATR_1, 2)
      &&   (sqClose("NULL",0, 2) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 2)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqOpen(NULL,0, 1) + (PriceEntryMult1 * sqBiggestRange("NULL",0, BiggestRangePeriod1, 1))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.6, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 140);
