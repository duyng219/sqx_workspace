...
input string CustomComment = "Strategy_0_1848";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12350;        //MagicNumber
...
input int HullMovingAvrPrd1 = 12;        //HullMovingAvrPrd1
input int EMAPeriod1 = 20;        //EMAPeriod1
input double StopLossCoef1 = 2;        //StopLossCoef1
input double TrailingStopCoef1 = 2.4;        //TrailingStopCoef1
input double TrailingActCef1 = 1.9;        //TrailingActCef1
...
#define HULLMOVINGAVERAGE_1 0     //iCustom(NULL,0, "SqHullMovingAverage", HullMovingAvrPrd1, 2.0, PRICE_CLOSE)
#define EMA_1 1     //iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 30)
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 85)
...
string sqStrategyName = "Strategy 0.1848";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(HULLMOVINGAVERAGE_1, 0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6));

     ShortEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(HULLMOVINGAVERAGE_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetAsk("Current"), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 2, StopLossCoef1 * sqGetIndicatorValue(ATR_1, 1)), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 20);
         ...
         sqSetTSActivation(_ticket, "TrailingActCef1 * sqGetIndicatorValue(ATR_2, 1)");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetBid("Current"), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, StopLossCoef1 * sqGetIndicatorValue(ATR_1, 1)), "Current");
      pt = sqFixMarketPrice(0, "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[HULLMOVINGAVERAGE_1] = iCustom(NULL,0, "SqHullMovingAverage", HullMovingAvrPrd1, 2.0, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[EMA_1] = iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 30);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 85);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("StopLossCoef1 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (StopLossCoef1 * sqGetIndicatorValue(ATR_1, 1));
   }
   if(idHash == sqStringHash("TrailingStopCoef1 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (TrailingStopCoef1 * sqGetIndicatorValue(ATR_1, 1));
   }
   if(idHash == sqStringHash("TrailingActCef1 * sqGetIndicatorValue(ATR_2, 1)")) {
      return (TrailingActCef1 * sqGetIndicatorValue(ATR_2, 1));
   }
   if(idHash == sqStringHash("StopLossCoef1 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (StopLossCoef1 * sqGetIndicatorValue(ATR_1, 1));
   }
