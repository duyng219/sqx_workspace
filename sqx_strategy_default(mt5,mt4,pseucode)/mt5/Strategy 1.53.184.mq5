...
input string CustomComment = "Strategy_1_53_184";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12407;        //MagicNumber
...
input int ATRChangesUpPeriod1 = 14;        //ATRChangesUpPeriod1
input double PriceEntryMult1 = 2.7;        //PriceEntryMult1
input double ProfitTarget1 = 6.1;        //ProfitTarget1
input double StopLoss1 = 5.3;        //StopLoss1
input int BBRangePeriod1 = 20;        //BBRangePeriod1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 1.4, PRICE_CLOSE)
#define ATR_1 1     //iCustom(NULL,0, "SqATR", ATRChangesUpPeriod1)
#define BOLLINGERBANDS_2 2     //iBands(NULL,0, BBRangePeriod1, 0, 2.0, PRICE_CLOSE)
#define BOLLINGERBANDS_3 3     //iBands(NULL,0, BBRangePeriod1, 0, 2, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 1.53.184";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((sqClose("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1))
      &&   changesUp(ATR_1, 3));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Close", 3) + (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 3)-sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 3)))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 101);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Close", 3) - (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_3, 1, 3)-sqGetIndicatorValue(BOLLINGERBANDS_3, 2, 3)))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 1.4, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL,0, "SqATR", ATRChangesUpPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBRangePeriod1, 0, 2.0, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_3] = iBands(NULL,0, BBRangePeriod1, 0, 2, PRICE_CLOSE);
