...
input string CustomComment = "Strategy_3_73_113";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12376;        //MagicNumber
...
input double ProfitTarget1 = 8.4;        //ProfitTarget1
input double StopLoss1 = 40;        //StopLoss1
input int MTATRPeriod1 = 61;        //MTATRPeriod1
...
#define PARABOLICSAR_1 1     //iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.10)
#define MTATR_1 2     //iATR(NULL,0, MTATRPeriod1)
#define PARABOLICSAR_2 3     //iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.1)
...
string sqStrategyName = "Strategy 3.73.113";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(PARABOLICSAR_1, 0, 3) + (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 3))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(PARABOLICSAR_2, 0, 3) - (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 3))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.10);
