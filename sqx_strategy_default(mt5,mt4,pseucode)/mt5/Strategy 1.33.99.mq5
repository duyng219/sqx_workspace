...
input string CustomComment = "Strategy_1_33_99";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12378;        //MagicNumber
...
input int BBBarClosesPeriod1 = 14;        //BBBarClosesPeriod1
input double PriceEntryMult1 = 0.1;        //PriceEntryMult1
input double ProfitTarget1 = 5;        //ProfitTarget1
...
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", Period1, PRICE_TYPICAL)
#define LOWEST_1 2     //iCustom(NULL,0, "SqLowest", Period1, PRICE_TYPICAL)
...
string sqStrategyName = "Strategy 1.33.99";
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 19);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", Period1, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", Period1, PRICE_TYPICAL);
