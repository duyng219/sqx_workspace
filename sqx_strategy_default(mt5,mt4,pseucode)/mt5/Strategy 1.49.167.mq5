...
input string CustomComment = "Strategy_1_49_167";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12401;        //MagicNumber
...
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 1.49.167";
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 95);
