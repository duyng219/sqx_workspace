...
input string CustomComment = "Strategy_4_75_195";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12370;        //MagicNumber
...
input int KCBarOpnAftOpnPrd1 = 6;        //KCBarOpnAftOpnPrd1
input double ProfitTarget1 = 9.8;        //ProfitTarget1
...
#define SMA_1 2     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 4.75.195";
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 30);
