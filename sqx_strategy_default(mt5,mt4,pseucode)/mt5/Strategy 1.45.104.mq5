...
input string CustomComment = "Strategy_1_45_104";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12403;        //MagicNumber
...
input double PriceEntryMult1 = 0.7;        //PriceEntryMult1
input double ProfitTarget1 = 6.9;        //ProfitTarget1
input double StopLoss1 = 35;        //StopLoss1
input double TrailingStop1 = 80;        //TrailingStop1
input double TrailingActCef1 = 2.7;        //TrailingActCef1
input int SMMAPeriod1 = 20;        //SMMAPeriod1
input int SmallestRangePeriod1 = 10;        //SmallestRangePeriod1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.1, PRICE_CLOSE)
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarClosesPeriod2, 0, 1.9, PRICE_CLOSE)
#define SMMA_1 2     //iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_CLOSE)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 30)
...
string sqStrategyName = "Strategy 1.45.104";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqClose("NULL",0, 3) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 3))
      &&   (sqClose("NULL",0, 2) < sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 2)));

     ShortEntrySignal = ((sqClose("NULL",0, 3) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 3))
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(SMMA_1, 0, 3) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 133);
         ...
         sqSetTSActivation(_ticket, "TrailingActCef1 * sqGetIndicatorValue(ATR_1, 1)");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod2, 0, 1.9, PRICE_CLOSE);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("TrailingActCef1 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (TrailingActCef1 * sqGetIndicatorValue(ATR_1, 1));
   }
   if(idHash == sqStringHash("StopLoss1")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), StopLoss1));
   }
