...
input string CustomComment = "Strategy_2_72_182";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12367;        //MagicNumber
...
input int IchimokuSnkSpnCrsBshSnkPrd1 = 52;        //IchimokuSnkSpnCrsBshSnkPrd1
...
input double StopLoss1 = 9.8;        //StopLoss1
input double TrailingStopCoef1 = 3.2;        //TrailingStopCoef1
...
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 75)
...
string sqStrategyName = "Strategy 2.72.182";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqIchimokuSenkouSpanCross(-1, NULL,0, ICHIMOKU_1, 1, 2);

     ShortEntrySignal = sqIchimokuSenkouSpanCross(1, NULL,0, ICHIMOKU_1, 1, 2);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(ICHIMOKU_2, 3, 2) + (PriceEntryMult1 * sqBarRange("NULL",0, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 120);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 75);
