...
input string CustomComment = "Strategy_1_21_163";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12384;        //MagicNumber
...
input int ATRChangesUpPeriod1 = 20;        //ATRChangesUpPeriod1
...
input double TrailingStop1 = 90;        //TrailingStop1
input int Period1 = 30;        //Period1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 1.9, PRICE_CLOSE)
#define ATR_1 1     //iCustom(NULL,0, "SqATR", ATRChangesUpPeriod1)
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", Period1, PRICE_LOW)
#define BOLLINGERBANDS_2 3     //iBands(NULL,0, BBRangePeriod1, 0, 2.1, PRICE_CLOSE)
#define LOWEST_1 4     //iCustom(NULL,0, "SqLowest", Period1, PRICE_HIGH)
...
string sqStrategyName = "Strategy 1.21.163";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 3) + (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 3)-sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 3)))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 3) - (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 3)-sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 3)))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 1.9, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL,0, "SqATR", ATRChangesUpPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", Period1, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBRangePeriod1, 0, 2.1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", Period1, PRICE_HIGH);
