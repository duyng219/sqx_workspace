...
input string CustomComment = "Strategy_2_81_164";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12386;        //MagicNumber
...
input int IchimokuKmoBrkBshKjnPrd1 = 140;        //IchimokuKmoBrkBshKjnPrd1
input int IchimokuKmoBrkBshSnkPrd1 = 102;        //IchimokuKmoBrkBshSnkPrd1
input double PriceEntryMult1 = 2.1;        //PriceEntryMult1
input double ProfitTarget1 = 165;        //ProfitTarget1
...
#define ATR_1 1     //iCustom(NULL, 0, "SqATR", 200)
...
string sqStrategyName = "Strategy 2.81.164";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqClose(NULL,0, 2) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 187);
