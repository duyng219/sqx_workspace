...
input string CustomComment = "Strategy_3_90_100";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12389;        //MagicNumber
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.8, PRICE_CLOSE)
#define PARABOLICSAR_1 1     //iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.20)
...
string sqStrategyName = "Strategy 3.90.100";
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 38);
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.8, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.20);
