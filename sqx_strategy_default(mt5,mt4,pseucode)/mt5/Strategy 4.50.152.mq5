...
input string CustomComment = "Strategy_4_50_152";
...
input int KCBarOpnAftOpnPrd1 = 12;        //KCBarOpnAftOpnPrd1
input double PriceEntryMult1 = 0.2;        //PriceEntryMult1
input double ProfitTarget1 = 1.6;        //ProfitTarget1
input double StopLoss1 = 8.4;        //StopLoss1
input double TrailingStopCoef1 = 3.4;        //TrailingStopCoef1
input int BollingerBandsPrd1 = 10;        //BollingerBandsPrd1
input int BiggestRangePeriod1 = 30;        //BiggestRangePeriod1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 2.5)
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BollingerBandsPrd1, 0, 1.5, PRICE_TYPICAL)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 170)
...
string sqStrategyName = "Strategy 4.50.152";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 2+1) > sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 2+1, true) && sqOpen("NULL",0, 2) < sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 2+1, true));

     ShortEntrySignal = (sqOpen("NULL",0, 2+1) < sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 2+1, true) && sqOpen("NULL",0, 2) > sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 2+1, true));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_1, 0 + 1, 1) + (PriceEntryMult1 * sqBiggestRange("NULL",0, BiggestRangePeriod1, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 32);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_1, 1 + 1, 1) - (PriceEntryMult1 * sqBiggestRange("NULL",0, BiggestRangePeriod1, 3))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 2.5);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BollingerBandsPrd1, 0, 1.5, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 170);
