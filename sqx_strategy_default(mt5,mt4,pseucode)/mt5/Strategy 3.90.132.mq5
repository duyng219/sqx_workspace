...
input string CustomComment = "Strategy_3_90_132";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12411;        //MagicNumber
...
string sqStrategyName = "Strategy 3.90.132";
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 79);
