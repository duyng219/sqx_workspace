...
input string CustomComment = "Strategy_4_29_101";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12415;        //MagicNumber
...
input int KCBarOpnAftOpnPrd1 = 8;        //KCBarOpnAftOpnPrd1
input int ExitAfterBars1 = 48;        //ExitAfterBars1
input double ProfitTarget1 = 1.5;        //ProfitTarget1
input double StopLoss1 = 7.1;        //StopLoss1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 2.0)
#define KELTNERCHANNEL_2 1     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 2)
#define KELTNERCHANNEL_3 2     //iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 2.5)
...
string sqStrategyName = "Strategy 4.29.101";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 1+1) > sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 1+1, true) && sqOpen("NULL",0, 1) < sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 1+1, true));

     ShortEntrySignal = (sqOpen("NULL",0, 1+1) < sqGetIndicatorValue(KELTNERCHANNEL_2, 0, 1+1, true) && sqOpen("NULL",0, 1) > sqGetIndicatorValue(KELTNERCHANNEL_2, 0, 1+1, true));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(KELTNERCHANNEL_3, 0, 1), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 54);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(KELTNERCHANNEL_3, 1, 1), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_3] = iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 2.5);
