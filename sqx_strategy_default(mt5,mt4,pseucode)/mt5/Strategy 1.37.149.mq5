...
input string CustomComment = "Strategy_1_37_149";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12372;        //MagicNumber
...
input double ProfitTarget1 = 6.6;        //ProfitTarget1
input double StopLoss1 = 5;        //StopLoss1
input int TEMAPeriod1 = 14;        //TEMAPeriod1
...
#define TEMA_1 3     //iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_CLOSE)
#define MTATR_1 4     //iATR(NULL,0, MTATRPeriod1)
...
string sqStrategyName = "Strategy 1.37.149";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqClose("NULL",0, 1) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 1))
      &&   (sqClose("NULL",0, 3) < sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 3)));

     ShortEntrySignal = ((sqClose("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_3, 1, 1))
      &&   (sqClose("NULL",0, 3) > sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 3)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(TEMA_1, 0, 3) + (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 22);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TEMA_1] = iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_CLOSE);
