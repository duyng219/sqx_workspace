...
input string CustomComment = "Strategy_1_47_169";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12413;        //MagicNumber
...
input double StopLoss1 = 55;        //StopLoss1
input int Period1 = 30;        //Period1
input int SmallestRangePeriod1 = 40;        //SmallestRangePeriod1
...
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2.1, PRICE_TYPICAL)
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", Period1, PRICE_CLOSE)
#define LOWEST_1 3     //iCustom(NULL,0, "SqLowest", Period1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 1.47.169";
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 75);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2.1, PRICE_TYPICAL);
