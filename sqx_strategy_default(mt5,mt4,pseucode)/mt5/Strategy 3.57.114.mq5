...
input string CustomComment = "Strategy_3_57_114";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12397;        //MagicNumber
...
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarClosesPeriod2, 0, 2.0, PRICE_CLOSE)
#define BOLLINGERBANDS_3 2     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2, PRICE_CLOSE)
#define BOLLINGERBANDS_4 3     //iBands(NULL,0, BBBarClosesPeriod2, 0, 2, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 3.57.114";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((sqClose("NULL",0, 3) > sqGetIndicatorValue(BOLLINGERBANDS_3, 1, 3))
      &&   (sqClose("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_4, 1, 1)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqDaily(NULL,0, "High", 3), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqDaily(NULL,0, "Low", 3), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod2, 0, 2.0, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_3] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_4] = iBands(NULL,0, BBBarClosesPeriod2, 0, 2, PRICE_CLOSE);
