...
input string CustomComment = "Strategy_1_40_123";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12396;        //MagicNumber
...
input int BBBarClosesPeriod2 = 20;        //BBBarClosesPeriod2
input double PriceEntryMult1 = 0.5;        //PriceEntryMult1
input double ProfitTarget1 = 2.4;        //ProfitTarget1
...
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarClosesPeriod2, 0, 2.1, PRICE_HIGH)
#define BOLLINGERBANDS_3 2     //iBands(NULL,0, BBBarClosesPeriod2, 0, 2.1, PRICE_LOW)
#define HIGHEST_1 3     //iCustom(NULL,0, "SqHighest", Period1, PRICE_WEIGHTED)
#define LOWEST_1 4     //iCustom(NULL,0, "SqLowest", Period1, PRICE_WEIGHTED)
...
string sqStrategyName = "Strategy 1.40.123";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((sqClose("NULL",0, 2) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 2))
      &&   (sqClose("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_3, 1, 1)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 1) + (PriceEntryMult1 * sqBarRange("NULL",0, 2))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 65);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 1) - (PriceEntryMult1 * sqBarRange("NULL",0, 2))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod2, 0, 2.1, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_3] = iBands(NULL,0, BBBarClosesPeriod2, 0, 2.1, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", Period1, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", Period1, PRICE_WEIGHTED);
