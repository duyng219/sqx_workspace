...
input string CustomComment = "Strategy_3_90_135";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12410;        //MagicNumber
...
#define MTATR_1 1     //iATR(NULL,0, MTATRPeriod1)
...
string sqStrategyName = "Strategy 3.90.135";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Low", 1) + (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 1))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "High", 1) - (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 1))), "Current");
