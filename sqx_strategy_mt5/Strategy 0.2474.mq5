...
input string CustomComment = "Strategy_0_2474";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12351;        //MagicNumber
...
input int MABarClosesPeriod1 = 20;        //MABarClosesPeriod1
input double PriceEntryMult1 = 2.5;        //PriceEntryMult1
input double StopLossCoef1 = 2.2;        //StopLossCoef1
input double TrailingStopCoef1 = 1.3;        //TrailingStopCoef1
input double TrailingActivation1 = 35;        //TrailingActivation1
input int ATRPeriod1 = 50;        //ATRPeriod1
...
#define MOVINGAVERAGE_1 0     //iMA(NULL,0, MABarClosesPeriod1, 0, MODE_LWMA, PRICE_LOW)
#define MOVINGAVERAGE_2 1     //iMA(NULL,0, MABarClosesPeriod1, 0, MODE_LWMA, PRICE_HIGH)
#define ATR_1 2     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 20)
#define HEIKENASHI_1 4     //255
...
string sqStrategyName = "Strategy 0.2474";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqClose("NULL",0, 1) < sqGetIndicatorValue(MOVINGAVERAGE_1, 1));

     ShortEntrySignal = (sqClose("NULL",0, 1) > sqGetIndicatorValue(MOVINGAVERAGE_2, 1));
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 2, StopLossCoef1 * sqGetIndicatorValue(ATR_2, 1)), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetTrailingStop(_ticket, "TrailingStopCoef1 * sqGetIndicatorValue(ATR_2, 1)", SLPTTYPE_RANGE);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqClose(NULL,0, 1) - (PriceEntryMult1 * sqGetIndicatorValue(ATR_1, 0, 1))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, StopLossCoef1 * sqGetIndicatorValue(ATR_2, 1)), "Current");
      pt = sqFixMarketPrice(0, "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[MOVINGAVERAGE_1] = iMA(NULL,0, MABarClosesPeriod1, 0, MODE_LWMA, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_2] = iMA(NULL,0, MABarClosesPeriod1, 0, MODE_LWMA, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL,0, "SqATR", ATRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 20);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("StopLossCoef1 * sqGetIndicatorValue(ATR_2, 1)")) {
      return (StopLossCoef1 * sqGetIndicatorValue(ATR_2, 1));
   }
   if(idHash == sqStringHash("TrailingStopCoef1 * sqGetIndicatorValue(ATR_2, 1)")) {
      return (TrailingStopCoef1 * sqGetIndicatorValue(ATR_2, 1));
   }
