...
input string CustomComment = "Strategy_4_19_105";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12373;        //MagicNumber
...
input int KCBarOpnAftOpnPrd1 = 20;        //KCBarOpnAftOpnPrd1
input int MACDMainFast1 = 3;        //MACDMainFast1
input int MACDMainSlow1 = 17;        //MACDMainSlow1
input int MACDMainSmooth1 = 16;        //MACDMainSmooth1
input double PriceEntryMult1 = 1.4;        //PriceEntryMult1
input double ProfitTarget1 = 140;        //ProfitTarget1
input double StopLoss1 = 65;        //StopLoss1
input double TrailingStop1 = 70;        //TrailingStop1
input double TrailingActivation1 = 100;        //TrailingActivation1
input int SMMAPeriod1 = 20;        //SMMAPeriod1
input int MTATRPeriod1 = 14;        //MTATRPeriod1
...
#define MACD_1 2     //iMACD(NULL,0, MACDMainFast1, MACDMainSlow1, MACDMainSmooth1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 4.19.105";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((changesUp(ATR_1, 3)
      ...
      &&   sqGetIndicatorValue(MACD_1, 0, 1, true) < 0);
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 78);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MACD_1] = iMACD(NULL,0, MACDMainFast1, MACDMainSlow1, MACDMainSmooth1, PRICE_CLOSE);
