...
input string CustomComment = "Strategy_2_38_124";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12369;        //MagicNumber
...
input int IchimokuKmoBrkBshTnkPrd1 = 59;        //IchimokuKmoBrkBshTnkPrd1
input int IchimokuKmoBrkBshKjnPrd1 = 63;        //IchimokuKmoBrkBshKjnPrd1
input int IchimokuKmoBrkBshSnkPrd1 = 52;        //IchimokuKmoBrkBshSnkPrd1
input int ExitAfterBars1 = 46;        //ExitAfterBars1
input double ProfitTarget1 = 5.2;        //ProfitTarget1
input double StopLoss1 = 5.5;        //StopLoss1
...
#define PARABOLICSAR_1 1     //iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.2)
#define PARABOLICSAR_2 2     //iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.2)
...
string sqStrategyName = "Strategy 2.38.124";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(PARABOLICSAR_1, 0, 2), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 93);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(PARABOLICSAR_2, 0, 2), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_2] = iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.2);
