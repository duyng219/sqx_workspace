...
input string CustomComment = "Strategy_1_37_172";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12379;        //MagicNumber
...
input double PriceEntryMult1 = 1.9;        //PriceEntryMult1
input double ProfitTarget1 = 4.7;        //ProfitTarget1
input double StopLoss1 = 75;        //StopLoss1
input int TEMAPeriod1 = 40;        //TEMAPeriod1
input int SmallestRangePeriod1 = 5;        //SmallestRangePeriod1
...
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarClosesPeriod2, 0, 1.8, PRICE_CLOSE)
#define BOLLINGERBANDS_3 2     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2, PRICE_CLOSE)
#define TEMA_1 3     //iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_WEIGHTED)
...
string sqStrategyName = "Strategy 1.37.172";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = ((sqClose("NULL",0, 2) > sqGetIndicatorValue(BOLLINGERBANDS_3, 1, 2))
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(TEMA_1, 0, 2) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod2, 0, 1.8, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_3] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TEMA_1] = iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_WEIGHTED);
