...
input string CustomComment = "Strategy_3_94_197";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12362;        //MagicNumber
...
input double PriceEntryMult1 = 1.3;        //PriceEntryMult1
...
#define SMMA_1 1     //iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_MEDIAN)
...
string sqStrategyName = "Strategy 3.94.197";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(SMMA_1, 0, 1) + (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 84);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMMA_1] = iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_MEDIAN);
