...
input string CustomComment = "Strategy_4_40_173";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12374;        //MagicNumber
...
input int ExitAfterBars1 = 42;        //ExitAfterBars1
input double ProfitTarget1 = 5.7;        //ProfitTarget1
input double StopLoss1 = 80;        //StopLoss1
input int Period1 = 25;        //Period1
input int ATRPeriod1 = 20;        //ATRPeriod1
...
string sqStrategyName = "Strategy 4.40.173";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 3) + (PriceEntryMult1 * sqGetIndicatorValue(ATR_1, 0, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 188);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 3) - (PriceEntryMult1 * sqGetIndicatorValue(ATR_1, 0, 3))), "Current");
