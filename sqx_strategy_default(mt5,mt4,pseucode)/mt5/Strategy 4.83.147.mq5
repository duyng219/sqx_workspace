...
input string CustomComment = "Strategy_4_83_147";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12399;        //MagicNumber
...
input double ProfitTarget1 = 4.5;        //ProfitTarget1
input double StopLoss1 = 50;        //StopLoss1
input int SMAPeriod1 = 99;        //SMAPeriod1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 2.9)
#define SMA_1 1     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_LOW)
#define ATR_1 2     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define SMA_2 3     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_HIGH)
...
string sqStrategyName = "Strategy 4.83.147";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(SMA_1, 0, 1) + (PriceEntryMult1 * sqGetIndicatorValue(ATR_1, 0, 1))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 119);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(SMA_2, 0, 1) - (PriceEntryMult1 * sqGetIndicatorValue(ATR_1, 0, 1))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 2.9);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMA_1] = iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL,0, "SqATR", ATRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMA_2] = iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_HIGH);
