...
input string CustomComment = "Strategy_2_16_148";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12382;        //MagicNumber
...
input int IchimokuKmoBrkBshTnkPrd1 = 196;        //IchimokuKmoBrkBshTnkPrd1
input int IchimokuKmoBrkBshKjnPrd1 = 92;        //IchimokuKmoBrkBshKjnPrd1
input int IchimokuKmoBrkBshSnkPrd1 = 52;        //IchimokuKmoBrkBshSnkPrd1
input int ExitAfterBars1 = 44;        //ExitAfterBars1
input double ProfitTarget1 = 115;        //ProfitTarget1
input double StopLoss1 = 4.3;        //StopLoss1
input int SMAPeriod1 = 30;        //SMAPeriod1
...
#define SMA_1 1     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 2.16.148";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(SMA_1, 0, 3), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 172);
