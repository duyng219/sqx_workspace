...
input string CustomComment = "Strategy_0_2229";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12349;        //MagicNumber
...
input int MABarOpensPeriod1 = 40;        //MABarOpensPeriod1
input double PriceEntryMult1 = 2.4;        //PriceEntryMult1
input double StopLossCoef1 = 2.1;        //StopLossCoef1
input double TrailingStop1 = 25;        //TrailingStop1
input double TrailingActivation1 = 15;        //TrailingActivation1
input int ATRPeriod1 = 30;        //ATRPeriod1
...
#define MOVINGAVERAGE_1 0     //iMA(NULL,0, MABarOpensPeriod1, 0, MODE_LWMA, PRICE_OPEN)
#define ATR_1 1     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define ATR_2 2     //iCustom(NULL, 0, "SqATR", 40)
...
string sqStrategyName = "Strategy 0.2229";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 1) < sqGetIndicatorValue(MOVINGAVERAGE_1, 1+1));

     ShortEntrySignal = (sqOpen("NULL",0, 1) > sqGetIndicatorValue(MOVINGAVERAGE_1, 1+1));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetTrailingStop(_ticket, "TrailingStop1", SLPTTYPE_RANGE);
...
bool initIndicators(){
   ...
   indicatorHandles[MOVINGAVERAGE_1] = iMA(NULL,0, MABarOpensPeriod1, 0, MODE_LWMA, PRICE_OPEN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL,0, "SqATR", ATRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 40);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("TrailingStop1")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), TrailingStop1));
   }
