...
input string CustomComment = "Strategy_4_77_197";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12391;        //MagicNumber
...
input double ProfitTarget1 = 9.4;        //ProfitTarget1
...
string sqStrategyName = "Strategy 4.77.197";
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 169);
