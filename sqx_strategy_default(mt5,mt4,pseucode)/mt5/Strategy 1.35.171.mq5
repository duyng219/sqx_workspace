...
input string CustomComment = "Strategy_1_35_171";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12357;        //MagicNumber
...
input int ATRChangesUpPeriod1 = 50;        //ATRChangesUpPeriod1
input double PriceEntryMult1 = 2;        //PriceEntryMult1
input double ProfitTarget1 = 4.7;        //ProfitTarget1
input double StopLoss1 = 45;        //StopLoss1
input int Period1 = 20;        //Period1
input int SmallestRangePeriod1 = 25;        //SmallestRangePeriod1
...
#define BOLLINGERBANDS_2 2     //iBands(NULL,0, BBBarClosesPeriod1, 0, 2, PRICE_CLOSE)
#define HIGHEST_1 3     //iCustom(NULL,0, "SqHighest", Period1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 1.35.171";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 3) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 179);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 3) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarClosesPeriod1, 0, 2, PRICE_CLOSE);
