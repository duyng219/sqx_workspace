...
input string CustomComment = "Strategy_1_16_130";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12395;        //MagicNumber
...
input double ProfitTarget1 = 155;        //ProfitTarget1
input double StopLoss1 = 50;        //StopLoss1
input double TrailingStopCoef1 = 4.4;        //TrailingStopCoef1
...
#define SMMA_1 3     //iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_CLOSE)
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 15)
...
string sqStrategyName = "Strategy 1.16.130";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(SMMA_1, 0, 3), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 15);
