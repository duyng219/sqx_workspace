...
input string CustomComment = "Strategy_4_75_150";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12385;        //MagicNumber
...
input int TEMAPeriod1 = 20;        //TEMAPeriod1
...
#define TEMA_1 1     //iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_MEDIAN)
...
string sqStrategyName = "Strategy 4.75.150";
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TEMA_1] = iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_MEDIAN);
