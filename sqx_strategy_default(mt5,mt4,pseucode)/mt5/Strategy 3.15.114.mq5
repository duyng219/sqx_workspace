...
input string CustomComment = "Strategy_3_15_114";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12358;        //MagicNumber
...
input int BBBarOpensPeriod1 = 50;        //BBBarOpensPeriod1
input int BBBarOpensPeriod2 = 10;        //BBBarOpensPeriod2
input double PriceEntryMult1 = 1.6;        //PriceEntryMult1
input double ProfitTarget1 = 8.2;        //ProfitTarget1
input double StopLoss1 = 60;        //StopLoss1
input double TrailingStopCoef1 = 3.3;        //TrailingStopCoef1
input int SMMAPeriod1 = 40;        //SMMAPeriod1
input int SmallestRangePeriod1 = 50;        //SmallestRangePeriod1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarOpensPeriod1, 0, 2.1, PRICE_CLOSE)
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarOpensPeriod2, 0, 1.6, PRICE_OPEN)
#define SMMA_1 2     //iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_CLOSE)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 35)
...
string sqStrategyName = "Strategy 3.15.114";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqOpen("NULL",0, 2+1) > sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 2+1, true) && sqOpen("NULL",0, 0) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 2+1, true))
      &&   (sqOpen("NULL",0, 2+1) > sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 2+1, true) && sqOpen("NULL",0, 0) < sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 2+1, true)));

     ShortEntrySignal = ((sqOpen("NULL",0, 2+1) < sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 2+1, true) && sqOpen("NULL",0, 2) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 2+1, true))
      &&   (sqOpen("NULL",0, 2+1) < sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 2+1, true) && sqOpen("NULL",0, 2) > sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 2+1, true)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(SMMA_1, 0, 3) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 189);
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarOpensPeriod1, 0, 2.1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarOpensPeriod2, 0, 1.6, PRICE_OPEN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMMA_1] = iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 35);
