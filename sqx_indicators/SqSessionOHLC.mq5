...
input int Type = TYPE_OPEN;   //Price type (Open=1, High=2, Low=3, Close=4)
input int StartHours = 0;
input int StartMinutes = 0;
input int EndHours = 0;
input int EndMinutes = 0;
input int DaysAgo = 0;
