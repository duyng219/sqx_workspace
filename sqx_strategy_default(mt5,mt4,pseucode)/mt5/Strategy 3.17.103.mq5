...
input string CustomComment = "Strategy_3_17_103";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12377;        //MagicNumber
...
input double ProfitTarget1 = 4.4;        //ProfitTarget1
...
#define SMMA_1 1     //iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_TYPICAL)
...
string sqStrategyName = "Strategy 3.17.103";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 3+1) > sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 3+1, true) && sqOpen("NULL",0, 0) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 3+1, true));

     ShortEntrySignal = (sqOpen("NULL",0, 3+1) < sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 3+1, true) && sqOpen("NULL",0, 3) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 3+1, true));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(SMMA_1, 0, 1) + (PriceEntryMult1 * sqGetIndicatorValue(ATR_1, 0, 2))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMMA_1] = iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_TYPICAL);
